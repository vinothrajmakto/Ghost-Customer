...
//                               ),
//                               Align(
//                                 alignment: AlignmentDirectional(0.99, 0.41),
//                                 child: Padding(
//                                   padding: EdgeInsetsDirectional.fromSTEB(
//                                       5, 0, 10, 0),
//                                   child: IconButton(
...
//                                   ),// Call to add a new button
//                                 ),
//                               ),
//                               // Display all drop location buttons inside the stack
//                               Column(
//                                 children: dropLocationButtons.map((button) {
//                                   return Padding(
//                                     padding: EdgeInsets.symmetric(vertical: 5.0), // Add some space between buttons
//                                     child: Container(
//                                       width: double.infinity,
//                                       height: 52,
//                                       color: FlutterFlowTheme.of(context).secondaryBackground, // Match the color
...
//The above code button is coming but not coming under container
...
//Button fixed at bottom inside stack
